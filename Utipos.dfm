object frmtipos: Tfrmtipos
  ...
  Width = 394
  Height = 174
  Hint = 'Pantalla de ABC de Tipo de Clientes'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Tipo de Clientes'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Width = 88
    Height = 30
    Hint = 'Dar de Alta a un Tipo de Cliente'
    ModalResult = 1
    Caption = '&Alta'
    Color = clWhite
    Font.Charset = DEFAULT_CHARSET
  ...
  object navegador: TRzDBNavigator
    ...
    Hints.Strings = (
      'Primer Tipo de Cliente'
      'Anterior Tipo de Cliente'
      'Siguiente Tipo de Cliente'
      'Ultimo Tipo de Cliente')
    ParentShowHint = False
    ShowHint = True
    TabOrder = 5
  ...
  object tbltipos: TMyTable
    TableName = 'tipos'
    Connection = DMAccesos.conexion
    BeforePost = tbltiposBeforePost
    FetchAll = True
    Left = 264
    object tbltiposidtipo: TStringField
      FieldName = 'idtipo'
      FixedChar = True
      Size = 3
    end
    object tbltiposnombre: TStringField
      FieldName = 'nombre'
      Size = 40
    end
    object tbltiposusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tbltiposfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tbltiposhora: TStringField
      FieldName = 'hora'
      Size = 15
    end
  end
