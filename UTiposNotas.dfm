object frmTiposNotas: TfrmTiposNotas
  Left = 509
  Top = 347
  Width = 386
  Height = 245
  Hint = 'Pantalla ABC de Tipos de Notas'
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Tipos de Notas'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Top = 186
    Width = 88
    Hint = 'Dar de Alta un Tipo de Nota'
    ModalResult = 1
    Caption = '&Alta'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
  ...
  object btnborrar: TRzBitBtn
    ...
    Top = 186
    Width = 94
    Hint = 'Elimina el Tipo de Nota actual'
    ModalResult = 1
    Caption = '&Borrar'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
  ...
  object btnmodificar: TRzBitBtn
    ...
    Top = 186
    Width = 97
    Hint = 'Editar los datos del Tipo de Nota Actual'
    ModalResult = 1
    Caption = '&Editar'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
  ...
  object DSTiposNotas: TDataSource
    DataSet = tblTiposNotas
    Left = 288
    Top = 56
  end
  ...
  object tblTiposNotas: TMyTable
    TableName = 'TiposNotas'
    Connection = DMAccesos.conexion
    BeforeOpen = tblTiposNotasBeforeOpen
    FetchAll = True
    Left = 216
    Top = 56
    object tblTiposNotasidtiponota: TIntegerField
      FieldName = 'idtiponota'
    end
    object tblTiposNotasnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tblTiposNotasdescripcion: TMemoField
      FieldName = 'descripcion'
      BlobType = ftMemo
    end
    object tblTiposNotasusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblTiposNotasfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tblTiposNotashora: TStringField
      FieldName = 'hora'
      Size = 15
    end
  end
