...
// Encoding : utf-8
// Version  : 1.0
// (13/10/2010 03:34:15 p.m. - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  ['{6B41B453-E7F6-D5F8-902E-9806B2833ACC}']
    function  Enviar(const Servicio: WideString; const Usuario: WideString; const Contrasena: WideString; const Celular: WideString; const Mensaje: WideString): Boolean; stdcall;
  end;
...
initialization
  ...
  InvRegistry.RegisterInvokeOptions(TypeInfo(InfomensajeSoap), ioDocument);
