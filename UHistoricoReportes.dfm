object frmHistoricoReportes: TfrmHistoricoReportes
  Left = 444
  Top = 311
  Width = 371
  Height = 293
  ...
  object btnremicionar: TRzBitBtn
    Left = 95
    Top = 181
    Width = 158
    Height = 32
    Caption = '&Generar Historico'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'MS Sans Serif'
  ...
  object chbTipoReporte: TRzComboBox
    ...
    Items.Strings = (
      ...
      'PAGOS X LINEA'
      'ANTIGUEDADES DE SALDOS SOLO FACTURAS'
