object frmNotasCredito: TfrmNotasCredito
  Left = 276
  Top = 186
  Width = 907
  Height = 607
  ...
  object sqlrejilla: TMyQuery
    ...
    SQL.Strings = (
      ...
      'if (a.aplica_desc = 1,'
        ...
        'where dnc.idmaq=:maq or (dnc.serie="NC" and dnc.idnc = :idnc) or' +
        'der by cod_cve')
    ReadOnly = True
    FetchAll = True
    Left = 8
  ...
  object sqlNotasCred: TMyQuery
    ...
    SQL.Strings = (
      ...
      'truncate(if (articulos.aplica_desc = 1,'
        ...
        'where DetNotasCredito.idmaq=:maq or (DetNotasCredito.serie = '#39'NC' +
        #39' and DetNotasCredito.idnc = :idnc)')
    ReadOnly = True
    FetchAll = True
    Left = 168
    Top = 256
