object frmColonias: TfrmColonias
  Left = 244
  Top = 206
  Width = 456
  Height = 272
  Hint = 'ABC de Colonias'
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Colonias'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Width = 100
    Height = 30
    Hint = 'Dar de Alta a una Colonia'
    ModalResult = 1
    Caption = '&Alta'
    Color = clWhite
    Font.Charset = DEFAULT_CHARSET
  ...
  object btnborrar: TRzBitBtn
    ...
    Width = 100
    Height = 30
    Hint = 'Elimina la Colonia Actual'
    ModalResult = 1
    Caption = '&Borrar'
    Color = clWhite
    Enabled = False
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 100
    Height = 30
    Hint = 'Editar los datos de la Colonia Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object edcp: TRzDBEdit
    ...
    Width = 111
    Height = 21
    Hint = 'Codigo Postal de esta Colonia'
    DataSource = DSColonias
    DataField = 'cp'
  ...
  object tblColonias: TMyTable
    TableName = 'colonias'
    Connection = DMAccesos.conexion
    BeforePost = tblColoniasBeforePost
    FetchAll = True
    Left = 224
    object tblColoniasidcol: TIntegerField
      FieldName = 'idcol'
    end
    object tblColoniasnombre: TStringField
      FieldName = 'nombre'
      Size = 250
    end
    object tblColoniasubicada: TSmallintField
      FieldName = 'ubicada'
    end
    object tblColoniascp: TIntegerField
      FieldName = 'cp'
    end
    object tblColoniasidtipoasenta: TIntegerField
      FieldName = 'idtipoasenta'
    end
    object tblColoniasidmnp: TIntegerField
      FieldName = 'idmnp'
    end
    object tblColoniasidestado: TIntegerField
      FieldName = 'idestado'
    end
    object tblColoniasusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblColoniashora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tblColoniasfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
  end
