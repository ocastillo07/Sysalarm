object frmtipos_actividades: Tfrmtipos_actividades
  Left = 374
  Top = 399
  Width = 401
  Height = 166
  Hint = 'Pantalla ABC de Tipos de Actividades'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Tipos de Actividades de los Vendedores'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Width = 88
    Height = 30
    Hint = 'Dar de Alta a un tipo de Actividad'
    ModalResult = 1
    Caption = '&Alta'
    Color = clWhite
    Font.Charset = DEFAULT_CHARSET
  ...
  object btnborrar: TRzBitBtn
    ...
    Width = 94
    Height = 30
    Hint = 'Elimina el Tipo de Actividad actual'
    ModalResult = 1
    Caption = '&Borrar'
    Color = clWhite
    Enabled = False
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos del tipo de actividad Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object ednombre: TRzDBEdit
    ...
    Width = 376
    Height = 21
    Hint = 'Nombre del Tipo de Actividad'
    DataSource = DStipos_actividades
    DataField = 'nombre'
  ...
  object DStipos_actividades: TDataSource
    DataSet = tbltipos_actividades
    Left = 304
  end
  ...
  object tbltipos_actividades: TMyTable
    TableName = 'tipos_actividades'
    Connection = DMAccesos.conexion
    BeforePost = tbltipos_actividadesBeforePost
    FetchAll = True
    Left = 216
    object tbltipos_actividadesidtipo_actividad: TIntegerField
      FieldName = 'idtipo_actividad'
    end
    object tbltipos_actividadesnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tbltipos_actividadesusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tbltipos_actividadeshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tbltipos_actividadesfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
  end
