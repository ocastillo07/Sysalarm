object frmgiros: Tfrmgiros
  Left = 323
  Top = 171
  Width = 401
  Height = 296
  Hint = 'Pantalla ABC de Giros de Empresas'
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Giros de Empresas'
  Color = clWhite
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos del Giro Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object tblgiros: TMyTable
    TableName = 'giros'
    Connection = DMAccesos.conexion
    AfterOpen = tblgirosAfterOpen
    BeforePost = tblgirosBeforePost
    FetchAll = True
    Left = 104
    Top = 25
    object tblgirosidgiro: TIntegerField
      FieldName = 'idgiro'
    end
    object tblgirosnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tblgirosdescripcion: TMemoField
      FieldName = 'descripcion'
      BlobType = ftMemo
    end
    object tblgirosfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tblgiroshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tblgirosusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
  end
