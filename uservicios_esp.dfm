object frmservicios_esp: Tfrmservicios_esp
  Left = 203
  Top = 121
  Width = 979
  Height = 403
  ...
  object RzLabel5: TRzLabel
    ...
    Width = 160
    Height = 13
    Caption = 'Servicios Cubiertos del a'#241'o:'
    BlinkIntervalOff = 5000
    BlinkIntervalOn = 20
  end
  object lbservicios: TRzLabel
    Left = 16
    Top = 344
    Width = 13
    Height = 13
  ...
  object dtservicio: TRzDateTimeEdit
    Left = 16
    Top = 80
    Width = 145
    Height = 21
  ...
  object gservicios: TcxGrid
    Left = 432
    Top = 8
    Width = 505
    Height = 345
    TabOrder = 7
    object vservicios: TcxGridDBTableView
      DataController.DataSource = dsserv
      ...
      object colservicio: TcxGridDBColumn
        Caption = 'Servcio'
        Width = 150
        DataBinding.FieldName = 'tiposerv'
      end
    ...
    object lservicios: TcxGridLevel
      GridView = vservicios
    end
  end
  object sqlserv: TMyQuery
    Connection = DMAccesos.conexion
    SQL.Strings = (
      'Select fecha, tiposerv, nota from servicios_esp')
    AfterOpen = sqlservAfterOpen
    FetchAll = True
    Left = 488
    Top = 88
  end
