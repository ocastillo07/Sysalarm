object frmdptoscategorias: Tfrmdptoscategorias
  Left = 207
  Top = 112
  Width = 473
  Height = 215
  Caption = 'Categorias de Departamentos'
  Color = clWhite
  ...
  object RzLabel2: TRzLabel
    ...
    Height = 13
    Caption = 
      'Nota: El factor sera actualizado directamente a los departamento' +
      's.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object tbldptos: TMyTable
    TableName = 'dptocategorias'
    Connection = DMAccesos.conexion
    AfterClose = tbldptosAfterClose
    BeforePost = tbldptosBeforePost
    AfterPost = tbldptosAfterPost
    ...
    object tbldptosiddptocategoria: TSmallintField
      ...
      Origin = 'dptocategorias.iddptocategoria'
    end
    object tbldptosnombre: TStringField
      FieldName = 'nombre'
      Origin = 'dptocategorias.nombre'
      Size = 30
    end
    object tbldptosusuario: TStringField
      FieldName = 'usuario'
      Origin = 'dptocategorias.usuario'
      Size = 15
    end
    object tbldptosfecha: TDateField
      FieldName = 'fecha'
      Origin = 'dptocategorias.fecha'
    end
    object tbldptoshora: TTimeField
      FieldName = 'hora'
      Origin = 'dptocategorias.hora'
    end
  end
end
