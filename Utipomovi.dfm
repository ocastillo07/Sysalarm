object frmtiposmovi: Tfrmtiposmovi
  Left = 384
  Top = 248
  Width = 406
  Height = 176
  Caption = 'ABC de Tipos de Movimientos'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Width = 88
    Height = 30
    Hint = 'Dar de alta un nuevo tipo'
    ModalResult = 1
    Caption = '&Alta'
    Color = clWhite
    Font.Charset = DEFAULT_CHARSET
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 88
    Height = 30
    Hint = 'Editar los datos del movimiento actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object tbltipomovi: TMyTable
    TableName = 'TipoMov'
    Connection = DMAccesos.conexion
    BeforePost = tbltipomoviBeforePost
    FetchAll = True
    Left = 304
    object tbltipomoviidmovi: TIntegerField
      FieldName = 'idmovi'
    end
    object tbltipomovinombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tbltipomoviafecta: TStringField
      FieldName = 'afecta'
      FixedChar = True
      Size = 1
    end
    object tbltipomoviusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tbltipomovifecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tbltipomovihora: TStringField
      FieldName = 'hora'
      Size = 15
    end
  end
