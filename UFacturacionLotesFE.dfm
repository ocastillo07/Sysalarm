object frmFacturacionLotesFE: TfrmFacturacionLotesFE
  Left = 303
  Top = 221
  Width = 820
  Height = 486
  Caption = 'Facturacion Electronica por lotes'
  Color = clWhite
  ...
  object RzGroupBar1: TRzGroupBar
    ...
    object GMetodo: TRzGroup
      ...
      OpenedHeight = 65
      DividerVisible = True
      Caption = 'Metodo de Facturacion'
      ParentColor = False
      object rbventas: TRzRadioButton
        Left = 8
        Top = 40
        Width = 115
        Height = 17
        ...
        TabOrder = 0
        Transparent = True
        OnClick = rbventasClick
      end
      object rbfechas: TRzRadioButton
        Left = 8
        Top = 24
        Width = 115
        Height = 17
    ...
    object Gventas: TRzGroup
      ...
      object edVdesde: TRzButtonEdit
        ...
        ShowHint = True
        TabOrder = 0
        OnChange = edVdesdeChange
        OnKeyPress = edVdesdeKeyPress
        ButtonKind = bkFind
        ButtonShortCut = 119
        AltBtnWidth = 14
        ButtonWidth = 14
        OnButtonClick = edVdesdeButtonClick
      end
      object edVHasta: TRzButtonEdit
        Left = 46
        Top = 48
        Width = 83
        Height = 20
