object frmsectores: Tfrmsectores
  Left = 335
  Top = 168
  Width = 394
  Height = 278
  Hint = 'Pantalla ABC de Sectores'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Sectores de Articulos'
  Color = clWhite
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos del Sector Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object mmdescripcion: TRzDBRichEdit
    ...
    Width = 369
    Height = 89
    Hint = 'Descripci'#243'n del Sector'
    ...
    OnKeyPress = mmdescripcionKeyPress
    DisabledColor = clWhite
    FocusColor = 16776176
    FrameColor = clActiveCaption
    FrameVisible = True
  ...
  object tblsectores: TMyTable
    TableName = 'SectoresArt'
    Connection = DMAccesos.conexion
    BeforeOpen = tblsectoresBeforeOpen
    FetchAll = True
    Left = 168
    Top = 56
    object tblsectoresidSectorArt: TIntegerField
      FieldName = 'idSectorArt'
    end
    object tblsectoresnombre: TStringField
      FieldName = 'nombre'
      Size = 50
    end
    object tblsectoresdescripcion: TMemoField
      FieldName = 'descripcion'
      BlobType = ftMemo
    end
    object tblsectoresusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblsectoresfecha: TStringField
      FieldName = 'fecha'
      Size = 16
    end
    object tblsectoreshora: TStringField
      FieldName = 'hora'
      Size = 14
    end
  end
