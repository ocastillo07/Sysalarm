object frmPrintLoteServicios: TfrmPrintLoteServicios
  Left = 609
  Top = 236
  Width = 485
  Height = 337
  Caption = 'Imprimir Consecutivo de Servicios'
  Color = 16119543
  ...
  object Panel2: TPanel
    ...
    object ede: TRzNumericEdit
      Left = 24
      Top = 24
      Width = 97
      Height = 21
      TabOrder = 0
      OnKeyPress = edeKeyPress
      DisplayFormat = ',0;(,0)'
    end
    object ehasta: TRzNumericEdit
      Left = 160
      Top = 24
      Width = 105
      Height = 21
  ...
  object cbotipo: TRzComboBox
    ...
    ParentCtl3D = False
    TabOrder = 0
    Text = '- Selecciona Tipo Impresion -'
    OnChange = cbotipoChange
    OnKeyPress = edeKeyPress
    Items.Strings = (
      '- Selecciona Tipo Impresion -'
      '- Todos -'
      '-  Por Numero de Servicios -')
    ItemIndex = 0
  end
