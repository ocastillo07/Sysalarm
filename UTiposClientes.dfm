object frmTiposClientes: TfrmTiposClientes
  ...
  Width = 386
  Height = 125
  Hint = 'ABC de Tipos de Clientes'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Tipos de Clientes'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Top = 66
    Width = 88
    Hint = 'Alta de un Nuevo Tipo de Cliente'
    ModalResult = 1
    Caption = '&Alta'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
  ...
  object btnborrar: TRzBitBtn
    ...
    Top = 66
    Width = 94
    Hint = 'Elimina el Tipo de Cliente Actual'
    ModalResult = 1
    Caption = '&Borrar'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
  ...
  object btnmodificar: TRzBitBtn
    ...
    Top = 66
    Width = 97
    Hint = 'Editar los datos del Tipo de Cliente Actual'
    ModalResult = 1
    Caption = '&Editar'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
  ...
  object ednombre: TRzDBEdit
    ...
    Width = 376
    Height = 21
    Hint = 'Nombre del Tipo de Cliente'
    DataSource = DSTiposClientes
    DataField = 'nombre'
  ...
  object tblTiposClientes: TMyTable
    TableName = 'lineas'
    Connection = DMAccesos.conexion
    BeforePost = tblTiposClientesBeforePost
    FetchAll = True
    Left = 240
    object tblTiposClientesidlinea: TIntegerField
      FieldName = 'idlinea'
    end
    object tblTiposClientesnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tblTiposClientescantidad: TFloatField
      FieldName = 'cantidad'
    end
    object tblTiposClientesimporte: TFloatField
      FieldName = 'importe'
    end
    object tblTiposClientesusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblTiposClienteshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tblTiposClientesfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
  end
