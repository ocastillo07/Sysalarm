object frmMarcacionCobranzaAdm: TfrmMarcacionCobranzaAdm
  Left = 321
  Top = 272
  Width = 274
  Height = 172
  Caption = 'Abrir Periodo de Marcaci'#243'n'
  Color = clBtnFace
  ...
  object pnlPrincipal: TRzPanel
    ...
    object btnSi: TRzBitBtn
      ...
      Width = 83
      Height = 27
      Hint = 'Guardar la configuraci'#243'n'
      Caption = '&Guardar'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -9
    ...
    object chkEstatus: TRzCheckBox
      Left = 56
      Top = 64
      Width = 131
      Height = 17
      Hint = 'Cierra el periodo de cobranza marcaci'#243'n telef'#243'nica'
