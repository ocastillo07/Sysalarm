object frmasig_even_vend1: Tfrmasig_even_vend1
  Left = 141
  Top = 153
  Width = 1007
  Height = 553
  Caption = 'Asignaci'#243'n de eventos a vendedores [Administradores]'
  Color = clBtnFace
  ...
  object sqleventos: TMyQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  estatus_eventos.nombre as status,if (oportunidades.nombr' +
        'e='#39#39' and oportunidades.apaterno='#39#39' and oportunidades.amaterno='#39#39 +
        ', rsocial,concat(oportunidades.nombre,'#39' '#39',oportunidades.apaterno' +
        ','#39' '#39',oportunidades.amaterno)) as nombre,'
      '  agenda_vendedores.idevento,'
      '  agenda_vendedores.idoportunidad,'
      
        ' if(usuarios.apaterno is NULL or usuarios.apaterno='#39#39', usuarios.' +
        'nombre, if(usuarios.amaterno is NULL or usuarios.amaterno='#39#39', co' +
        'ncat(usuarios.nombre,'#39' '#39', usuarios.apaterno), '
      
        'concat(usuarios.nombre, '#39' '#39', usuarios.apaterno, '#39' '#39', usuarios.am' +
        'aterno))) as Vendedor,oportunidades.cuenta'
      'FROM'
      
        'agenda_vendedores LEFT JOIN oportunidades ON (agenda_vendedores.' +
        'idoportunidad = oportunidades.idoportunidad) LEFT join estatus_e' +
        'ventos on estatus_eventos.idestatus = agenda_vendedores.idestatu' +
        's'
      
        'LEFT join usuarios on usuarios.idusuario = agenda_vendedores.idv' +
        'endedor'
      
        'WHERE (estatus_eventos.finaliza='#39'NO'#39')   order by  agenda_vendedo' +
        'res.idoportunidad desc')
