object frmturnos: Tfrmturnos
  ...
  Width = 410
  Height = 230
  Hint = 'Pantalla ABC de Turnos'
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Turnos'
  Color = clWhite
  ...
  object dtpinicio: TRzDBDateTimePicker
    Left = 8
    Top = 101
    Width = 89
    Height = 21
  ...
  object dtpfin: TRzDBDateTimePicker
    Left = 104
    Top = 101
    Width = 89
    Height = 21
  ...
  object tblturnos: TMyTable
    TableName = 'turnos'
    Connection = DMAccesos.conexion
    AfterOpen = tblturnosAfterOpen
    AfterClose = tblturnosAfterClose
    FetchAll = True
    Left = 248
    object tblturnosidturno: TIntegerField
      FieldName = 'idturno'
      Origin = 'turnos.idturno'
    end
    object tblturnosnombre: TStringField
      FieldName = 'nombre'
      Origin = 'turnos.nombre'
      Size = 30
    end
    object tblturnosHoraInicio: TTimeField
      FieldName = 'HoraInicio'
      Origin = 'turnos.HoraInicio'
    end
    object tblturnosHoraFin: TTimeField
      FieldName = 'HoraFin'
      Origin = 'turnos.HoraFin'
    end
    object tblturnosidarea: TIntegerField
      FieldName = 'idarea'
      Origin = 'turnos.idarea'
    end
    object tblturnosusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblturnoshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tblturnosfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
  end
