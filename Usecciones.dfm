object frmsecciones: Tfrmsecciones
  Left = 369
  Top = 219
  Width = 394
  Height = 278
  Hint = 'Pantalla ABC de Secciones'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Secciones'
  Color = clWhite
  ...
  object btnalta: TRzBitBtn
    ...
    Width = 88
    Height = 30
    Hint = 'Dar de Alta a una Secci'#243'n'
    ModalResult = 1
    Caption = '&Alta'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
  ...
  object btnborrar: TRzBitBtn
    ...
    Width = 94
    Height = 30
    Hint = 'Elimina la Secci'#243'n actual'
    ModalResult = 1
    Caption = '&Borrar'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos de la Secci'#243'n Actual'
    ModalResult = 1
    Caption = '&Editar'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET
  ...
  object navegador: TRzDBNavigator
    ...
    Hints.Strings = (
      'Primer Seccion'
      'Anterior Secci'#243'n'
      'Siguiente Secci'#243'n'
      'Ultima Secci'#243'n')
    TabOrder = 7
  ...
  object mmdescripcion: TRzDBRichEdit
    ...
    Width = 369
    Height = 89
    Hint = 'Descripci'#243'n de la secci'#243'n'
    HelpType = htKeyword
  ...
  object tblsecciones: TMyTable
    TableName = 'secciones'
    Connection = DMAccesos.conexion
    BeforeOpen = tblseccionesBeforeOpen
    FetchAll = True
    Left = 248
    Top = 56
    object tblseccionesidseccion: TIntegerField
      FieldName = 'idseccion'
    end
    object tblseccionesnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tblseccionesdescripcion: TMemoField
      FieldName = 'descripcion'
      BlobType = ftMemo
    end
    object tblseccionesusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblseccionesfecha: TStringField
      FieldName = 'fecha'
      Size = 16
    end
    object tblseccioneshora: TStringField
      FieldName = 'hora'
      Size = 14
    end
  end
