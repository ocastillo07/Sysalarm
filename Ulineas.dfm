object frmlineas: Tfrmlineas
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos de la linea Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object tbllineas: TMyTable
    TableName = 'lineas'
    Connection = DMAccesos.conexion
    BeforePost = tbllineasBeforePost
    FetchAll = True
    Left = 256
    object tbllineasidlinea: TIntegerField
      FieldName = 'idlinea'
    end
    object tbllineasnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tbllineascantidad: TFloatField
      FieldName = 'cantidad'
    end
    object tbllineasimporte: TFloatField
      FieldName = 'importe'
    end
    object tbllineasusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tbllineashora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tbllineasfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
  end
