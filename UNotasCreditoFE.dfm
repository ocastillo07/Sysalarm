object frmNotasCreditoFE: TfrmNotasCreditoFE
  Left = 320
  Top = 90
  Width = 907
  Height = 608
  ...
  object btnedix: TRzBitBtn
    Left = 784
    Top = 0
    Width = 105
    Height = 33
    Caption = 'Reenviar a Edix'
    Enabled = False
    HotTrack = True
    TabOrder = 12
    OnClick = btnedixClick
    Glyph.Data = {
      36060000424D3606000000000000360400002800000020000000100000000100
      08000000000000020000630B0000630B00000001000000000000000000003300
      00006600000099000000CC000000FF0000000033000033330000663300009933
  ...
  object sqlrejilla: TMyQuery
    ...
    SQL.Strings = (
        ...
        ',round(a.iva/100,2) as Iva,'
      'round(a.desc_esp/100,2) as descuento,'
      ...
      'round(if (a.aplica_desc = 1,'
        ...
        '(((dnc.costo/a.piezasxunidad)-((dnc.costo/a.piezasxunidad)*a.des' +
        'c_esp/100))*a.iva/100))*dnc.piezas), ('
      '(dnc.costo+(dnc.costo*a.iva/100))*dnc.cant) +'
      
        '(((dnc.costo/a.piezasxunidad)+((dnc.costo/a.piezasxunidad)*a.iva' +
        '/100))*dnc.piezas))*dnc.tc,2) as Total,'
      ''
      
        'a.piezasxunidad,(a.tinstalacion*dnc.cant)  as tinstalacion,dnc.u' +
        'tilidad,dnc.paquete'
      
        'from DetNotasCredito dnc inner join articulos a on dnc.cod_cve =' +
        ' a.cod_cve'
      
        'where dnc.idmaq=:maq or concat(dnc.serie,dnc.idnc) = :idnc order' +
        ' by cod_cve')
    ReadOnly = True
    FetchAll = True
    Left = 8
  ...
  object sqlNotasCred: TMyQuery
    ...
    SQL.Strings = (
      ...
      'truncate(if (articulos.aplica_desc = 1,'
        ...
        'where DetNotasCredito.idmaq=:maq or concat(DetNotasCredito.serie' +
        ', DetNotasCredito.idnc) = ":idnc"')
    ReadOnly = True
    FetchAll = True
    Left = 168
    Top = 256
