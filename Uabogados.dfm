object frmabogados: Tfrmabogados
  Left = 309
  Top = 278
  Width = 416
  Height = 327
  Caption = 'ABC de Abogados'
  Color = clWhite
  ...
  object btnborrar: TRzBitBtn
    ...
    Width = 94
    Height = 30
    Hint = 'Elimina el Abogado actual'
    ModalResult = 1
    Caption = '&Borrar'
    Color = clWhite
    Enabled = False
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos del Abogado Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object mmdescripcion: TRzDBRichEdit
    Left = 15
    Top = 165
    Width = 370
    Height = 60
    Hint = 'Descripci'#243'n del Abogado'
  ...
  object edpaterno: TRzDBEdit
    ...
    Width = 116
    Height = 21
    Hint = 'Apellido Materno del Abogado'
    DataSource = DSabogados
    DataField = 'apaterno'
    CharCase = ecUpperCase
    DisabledColor = clWhite
  ...
  object edmaterno: TRzDBEdit
    ...
    Width = 121
    Height = 21
    Hint = 'Apellido paterno del Abogado'
    DataSource = DSabogados
    DataField = 'amaterno'
    CharCase = ecUpperCase
    DisabledColor = clWhite
  ...
  object btntelefono: TRzBitBtn
    ...
    Top = 113
    Width = 101
    Hint = 'Asignar telefono(s) a este abogado'
    Caption = '&Telefonos'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object tblabogados: TMyTable
    TableName = 'abogados'
    Connection = DMAccesos.conexion
    AfterPost = tblabogadosAfterPost
    FetchAll = True
    Left = 232
    Top = 32
    object tblabogadosidabogado: TIntegerField
      FieldName = 'idabogado'
    end
    object tblabogadosnombre: TStringField
      FieldName = 'nombre'
      Size = 30
    end
    object tblabogadosapaterno: TStringField
      FieldName = 'apaterno'
    end
    object tblabogadosamaterno: TStringField
      FieldName = 'amaterno'
    end
    object tblabogadosdescripcion: TMemoField
      FieldName = 'descripcion'
      BlobType = ftMemo
    end
    object tblabogadosusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblabogadosfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tblabogadoshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
    object tblabogadosidtel: TIntegerField
      FieldName = 'idtel'
    end
  end
