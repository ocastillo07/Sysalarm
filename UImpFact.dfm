object frmImpFact: TfrmImpFact
  ...
  object cxboletas: TcxGrid
    ...
    object vista: TcxGridDBTableView
      DataController.DataSource = DSBuscaPed
      ...
      object cxdbremicion: TcxGridDBColumn
        Caption = 'Remicion'
        Options.Sorting = False
        DataBinding.FieldName = 'idremicion'
      end
      object cxdbfactura: TcxGridDBColumn
        Caption = 'Factura'
        Options.Sorting = False
        Width = 108
        DataBinding.FieldName = 'idfactura'
      end
      object cxdbTotMn: TcxGridDBColumn
        Options.Sorting = False
        Width = 72
    ...
    object nivel: TcxGridLevel
      Caption = 'prueba semanal'
      GridView = vista
    end
  end
  object rgTFactura: TRzRadioGroup
    Left = 0
    Top = -2
    Width = 127
    Height = 70
  ...
  object DSBuscaPed: TDataSource
    DataSet = sqlBuscaPed
    Left = 96
    Top = 128
  end
  object sqlBuscaPed: TMyQuery
    Connection = DMAccesos.conexion
    SQL.Strings = (
      
        'select RemiFact.idremicion,RemiFact.idfactura,pedidos.idpedido,p' +
        'edidos.idcliente,pedidos.TotMn from pedidos inner join RemiFact ' +
        'on pedidos.idpedido = RemiFact.idpedido  where RemiFact.idfactur' +
        'a>='#39'P1500'#39)
    FetchAll = True
    Left = 24
    Top = 128
