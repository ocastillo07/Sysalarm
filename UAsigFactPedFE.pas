...
var
  frmAsigFactPedFE: TfrmAsigFactPedFE;
...
procedure TfrmAsigFactPedFE.btnaltaClick(Sender: TObject);
var fact,idpedido,idremicion,Banco,CodBarras,CodBBVA,CodBanorte,cliente,total:string;
begin
   with dmreportes do
   begin
      ...
      begin
         ...
         if monthof(date) <> monthof(sqlgeneral.FieldByName('Fecha').AsDateTime) then
         begin
         ...
         begin
            ...
            CancelarFacturaElectronica(fact, true);
...
procedure TfrmAsigFactPedFE.FormClose(Sender: TObject; var Action: TCloseAction);
begin
action:=cafree;
end;

procedure TfrmAsigFactPedFE.btncancelarClick(Sender: TObject);
begin
close;
end;

procedure TfrmAsigFactPedFE.FormShow(Sender: TObject);
begin
edpedido.SetFocus;
end;

procedure TfrmAsigFactPedFE.btnaltaKeyPress(Sender: TObject; var Key: Char);
begin
if (key = #13) then
...
procedure TfrmAsigFactPedFE.edpedidoKeyPress(Sender: TObject; var Key: Char);
begin
