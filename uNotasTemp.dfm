object frmNotasTemp: TfrmNotasTemp
  Left = 265
  Top = 162
  Width = 789
  Height = 394
  Caption = 'Notas Temporales'
  Color = clBtnFace
  ...
  object gnotas: TcxGrid
    ...
    object vnotas: TcxGridDBTableView
      ...
      object colfdesde: TcxGridDBColumn
        Caption = 'Desde'
        Width = 65
        DataBinding.FieldName = 'dfecha'
      end
      object colhdesde: TcxGridDBColumn
        Caption = 'Desde'
        Width = 64
        DataBinding.FieldName = 'dhora'
      end
      object colfhasta: TcxGridDBColumn
        Caption = 'Hasta'
        Width = 64
        DataBinding.FieldName = 'hfecha'
      end
      object colhhasta: TcxGridDBColumn
        Caption = 'Hasta'
        Width = 65
        DataBinding.FieldName = 'hhora'
      end
    end
    object lnotas: TcxGridLevel
      GridView = vnotas
    end
  end
  ...
  object sqlnotas: TMyQuery
    Connection = DMAccesos.conexion
    SQL.Strings = (
      
        'Select * from notas where idnota = 6293 and TipoNota like "%TEMP' +
        'ORAL%"')
    FetchAll = True
    Left = 424
    Top = 16
