object frmfuentes: Tfrmfuentes
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos de la Fuente Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object tblfuentes: TMyTable
    TableName = 'fuentes'
    Connection = DMAccesos.conexion
    AfterEdit = tblfuentesAfterEdit
    BeforePost = tblfuentesBeforePost
    AfterPost = tblfuentesAfterEdit
    AfterCancel = tblfuentesAfterEdit
    FetchAll = True
    Left = 248
    object tblfuentesidfuente: TIntegerField
      FieldName = 'idfuente'
    end
    object tblfuentesnombre: TStringField
      FieldName = 'nombre'
      Size = 40
    end
    object tblfuentesusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblfuentesfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tblfuenteshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
  end
