object frmareas: Tfrmareas
  ...
  Width = 770
  Height = 347
  Hint = 'Pantalla ABC de Areas'
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de '#193'reas'
  Color = clWhite
  ...
  object RzLabel3: TRzLabel
    ...
    Width = 158
    Height = 13
    Caption = 'Email del Auditor de Travel:'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object edemail: TRzDBMemo
    Left = 8
    Top = 176
    Width = 737
    Height = 82
    DataField = 'EmailTravel'
    DataSource = DSareas
    Enabled = False
    TabOrder = 9
    DisabledColor = clWhite
  ...
  object cbareadepende: TRzComboBox
    Left = 392
    Top = 56
    Width = 353
    Height = 21
  ...
  object tblareas: TMyTable
    TableName = 'areas'
    Connection = DMAccesos.conexion
    BeforeOpen = tblareasBeforeOpen
    BeforePost = tblareasBeforePost
    AfterPost = tblareasAfterPost
    FetchAll = True
    Left = 576
    Top = 8
    object tblareasnombre: TStringField
      DisplayWidth = 30
      FieldName = 'nombre'
      Visible = False
      Size = 30
    end
    object tblareasidarea: TIntegerField
      DisplayWidth = 10
      FieldName = 'idarea'
      Visible = False
    end
    object tblareasdescripcion: TMemoField
      DisplayWidth = 10
      FieldName = 'descripcion'
      Visible = False
      BlobType = ftMemo
    end
    object tblareasfecha: TStringField
      DisplayWidth = 15
      FieldName = 'fecha'
      Visible = False
      Size = 15
    end
    object tblareashora: TStringField
      DisplayWidth = 15
      FieldName = 'hora'
      Visible = False
      Size = 15
    end
    object tblareasusuario: TStringField
      DisplayWidth = 30
      FieldName = 'usuario'
      Visible = False
      Size = 30
    end
    object tblareasEmailTravel: TMemoField
      FieldName = 'EmailTravel'
      BlobType = ftMemo
    end
    object tblareasareadepende: TIntegerField
      FieldName = 'areadepende'
    end
    object tblareasestatus: TBooleanField
      FieldName = 'estatus'
    end
  end
