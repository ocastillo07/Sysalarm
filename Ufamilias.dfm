object frmfamilias: Tfrmfamilias
  ...
  Width = 394
  Height = 150
  Hint = 'ABC de Familias'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Familias'
  Color = clWhite
  ...
  object btnborrar: TRzBitBtn
    ...
    Width = 94
    Height = 30
    Hint = 'Eliminar la Familia Actual'
    ModalResult = 1
    Caption = '&Borrar'
    Color = clWhite
    Enabled = False
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos de la familia actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object tblfamilias: TMyTable
    TableName = 'familias'
    Connection = DMAccesos.conexion
    AfterOpen = tblfamiliasAfterOpen
    AfterClose = tblfamiliasAfterClose
    BeforePost = tblfamiliasBeforePost
    FetchAll = True
    Left = 256
    object tblfamiliasidfamilia: TIntegerField
      FieldName = 'idfamilia'
      Origin = 'familias.idfamilia'
    end
    object tblfamiliasnombre: TStringField
      FieldName = 'nombre'
      Origin = 'familias.nombre'
      Size = 30
    end
    object tblfamiliasusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblfamiliasfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tblfamiliashora: TStringField
      FieldName = 'hora'
      Size = 15
    end
  end
