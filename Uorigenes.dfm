object frmorigenes: Tfrmorigenes
  Left = 347
  Top = 230
  Width = 394
  Height = 158
  Hint = 'Pantallad de ABC de Origenes'
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'ABC de Origenes'
  Color = clWhite
  ...
  object btnmodificar: TRzBitBtn
    ...
    Width = 97
    Height = 30
    Hint = 'Editar los datos del Origen Actual'
    ModalResult = 1
    Caption = '&Editar'
    Color = clWhite
    Enabled = False
  ...
  object chkreporte: TRzDBCheckBox
    Left = 288
    Top = 32
    Width = 89
    Height = 33
  ...
  object tblorigenes: TMyTable
    TableName = 'origen'
    Connection = DMAccesos.conexion
    AfterEdit = tblorigenesAfterEdit
    BeforePost = tblorigenesBeforePost
    AfterPost = tblorigenesAfterEdit
    AfterCancel = tblorigenesAfterEdit
    FetchAll = True
    Left = 256
    object tblorigenesidorigen: TIntegerField
      FieldName = 'idorigen'
    end
    object tblorigenesnombre: TStringField
      FieldName = 'nombre'
      Size = 25
    end
    object tblorigenesreporte: TBooleanField
      FieldName = 'reporte'
    end
    object tblorigenesusuario: TStringField
      FieldName = 'usuario'
      Size = 30
    end
    object tblorigenesfecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object tblorigeneshora: TStringField
      FieldName = 'hora'
      Size = 15
    end
  end
